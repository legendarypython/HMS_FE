...
import AntenatalDetailsForm from './component/Patient/AddAnteNatal'; // Import AntenatalDetailsForm component 
import {AddPatientForm} from './component/Patient/AddPatient';
...
function App() {
  return (
    ...
    <Router>
      ...
      <Route exact path="/patient/add" component={AddPatientForm} />
      <Route exact path="/patient/add/anteNatalForm/:patientId" component={AntenatalDetailsForm} />
      <Route exact path="/patient/add/infertilityForm/:patientId" component={InfertilityDetailsForm} />
      <Route exact path="/patient/view/:patientId" component={PatientDetails} />
      <Route exact path="/patient/view/anteNatalForm/:patientId" component={ViewAntenatalForm} />
      <Route exact path="/patient/view/infertilityForm/:patientId" component={ViewInfertilityForm} />
